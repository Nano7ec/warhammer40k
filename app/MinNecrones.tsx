...
import AmrakyrtheTraveller from '@/components/miniaturas/Necrones/AmrakyrtheTraveller';
import IlluminorSzeras from '@/components/miniaturas/Necrones/IlluminorSzeras';
import ImotekhTheStormlord from '@/components/miniaturas/Necrones/ImotekTheStormlord';
import NemesorZahndrekh from '@/components/miniaturas/Necrones/NemesorZahndrekh';
import OrikanTheDiviner from '@/components/miniaturas/Necrones/OrikanTheDiviner';
import TrazynTheInfinite from '@/components/miniaturas/Necrones/TrazynTheInfinite';
import VargardObyron from '@/components/miniaturas/Necrones/VargardObyron';

export default function MinNecrones(){
    return(
        <ScrollView>
        <>
