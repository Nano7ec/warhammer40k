import Battlewagon from '@/components/miniaturas/Orks/Battlewagon';
import BeastBoss from '@/components/miniaturas/Orks/BeastBoss';
import BeastBossOnSq from '@/components/miniaturas/Orks/BeastBossOnSq';
import BeastSnaggaBoyz from '@/components/miniaturas/Orks/BeastSnaggaBoyz';
import React from 'react';
import { Text, ScrollView, StyleSheet, View } from 'react-native';
export default function MinOrks (){
return(
    <ScrollView>
    <>
