    ...
    return( 
        <ScrollView style={{ flex: 1, backgroundColor: '#7d8cc3', padding: 7}}>
           ...
           <Text style={{textTransform: 'uppercase',textAlign: 'center', color: '#fff', fontWeight: 'bold', backgroundColor: '#11183f', fontSize: 24, padding: 5, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}>La sombra del caos
            ...
            {"\n"} <Text style={{fontSize: 18, backgroundColor: '#3b3d5e', color: '#fff',paddingBottom: 3,borderBottomLeftRadius: 10, borderBottomRightRadius: 10}}>
            ...
            {"\n"}<Text style={{  fontStyle: 'italic',textTransform: 'uppercase',textAlign: 'center', color: '#fff', fontWeight: 'bold', backgroundColor: '#3b3d5e',fontSize: 24, padding: 5, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}>
                    REALIDAD CORROMPIDA.
                    {"\n"} <Text style={{fontSize:16, textTransform: 'uppercase', textAlign:'center', color : "#fff", fontWeight: 'bold'}}>INCURSION DEMONÍACA – ESTRATAGEMA ESTRATÉGICA</Text>
                    </Text> {"\n"}
            ...
            {"\n"}<Text style={{  fontStyle: 'italic',textTransform: 'uppercase',textAlign: 'center', color: '#fff', fontWeight: 'bold', backgroundColor: '#3b3d5e',fontSize: 24, padding: 5, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}>
                    TRAGO DE TERROR.
                    {"\n"} <Text style={{fontSize:16, textTransform: 'uppercase', textAlign:'center', color : "#fff", fontWeight: 'bold'}}>INCURSION DEMONÍACA – ESTRATAGEMA DE TÁCTICA DE BATALLA</Text>
                    </Text> {"\n"}
