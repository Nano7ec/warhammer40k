...
import LoganGrimnar from '@/components/miniaturas/SpaceWolves/LoganGrimnar';
import LoganGrimnaronStorm from '@/components/miniaturas/SpaceWolves/LoganGrimnaronStorm';
import NjalStormcaller from '@/components/miniaturas/SpaceWolves/NjalStormcaller';

export default function MinSpaceWolves(){
    return(
        <ScrollView>
        <>
