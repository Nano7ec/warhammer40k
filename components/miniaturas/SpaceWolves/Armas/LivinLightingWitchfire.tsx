...
export default function LivinLithingWitchfire(){
    return(  
        <View>
          ...
          <>
            <View style={styles.tableCell}>
              ...
              <Text style={styles.cellText}><Text style={styles.wapo}>Living Lightning – witchfire [PSYCHIC, SUSTAINED HITS 2]</Text></Text>
            </View>
            <View style={styles.tableCell}>
