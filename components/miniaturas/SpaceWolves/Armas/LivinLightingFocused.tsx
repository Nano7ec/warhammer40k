...
export default function LivinLithingWitchFocused(){
    return(  
        <View>
          ...
          <>
            <View style={styles.tableCell}>
              ...
              <Text style={styles.cellText}><Text style={styles.wapo}>Living Lightning – focused witchfire
              [HAZARDOUS, PSYCHIC, SUSTAINED HITS 2]</Text></Text>
            </View>
            <View style={styles.tableCell}>
