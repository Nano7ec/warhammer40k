...
export default function StaffonTheStormcaller(){
    return(  
        <View>
          ...
          <>
            <View style={styles.tableCell}>
              ...
              <Text style={styles.cellText}><Text style={styles.wapo}>Staff of the Stormcaller [PSYCHIC, SUSTAINED HITS 2]</Text></Text>
            </View>
            <View style={styles.tableCell}>
