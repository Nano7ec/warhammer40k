...
import FlurryofTeeth from './Armas/FlurryofTeethandClaws';

const { width } = Dimensions.get('screen');

export default function LoganGrimnaronStorm(){
    return(
        <View>
           <>
        <Image resizeMode="stretch" style={styles.image} source={require('./img/LoganGrimnaronStorm.png')} />
