...
export default function Wardens() {
    return (
        <View>
            <>
                <Image resizeMode="stretch" style={styles.image} source={require('../Custodes/images/Wardens.png')} />
                ...
                <Text style={styles.descrip}>
                    ...
                    {'\n'}<Text style={styles.wapo}>Voluntad Resuelta:</Text> Mientras un Personaje esté liderando esta unidad, cada vez que un ataque tenga como objetivo esta unidad, si la característica de Fuerza de ese ataque es mayor que la característica de Resistencia de esta unidad, resta 1 de la tirada para herir.
                    {'\n'}<Text style={styles.wapo}>Fortaleza Viviente:</Text> Una vez por batalla, al inicio de cualquier fase, esta unidad puede usar esta habilidad. Si lo hace, hasta el final de la fase, los modelos en esta unidad tienen la habilidad No Sentir Dolor 4+.
                </Text>
                <Text style={styles.border}>
        ...
        <>
          ...
          <Text style={styles.descrip}>■ 3-6 Guardianes Custodios
