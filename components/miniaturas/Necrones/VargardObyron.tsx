...
export default function VargardObyron(){
    return(
        <View>
           <>
        <Image resizeMode="stretch" style={styles.image} source={require('./img/VargardObyron.png')} />
        ...
        {'\n'}<Text style={styles.wapo}>Core:</Text>Leader
          ...
          {'\n'}<Text style={styles.wapo}>Ghostwalk Mantle:</Text> Mientras este modelo lidera una unidad, los modelos de esa unidad tienen la habilidad Lucha primero.

          {'\n'}<Text style={styles.wapo}>The Vargard’s Duty:</Text>Mientras este modelo esté en la misma unidad que Nemesor Zahndrekh, las miniaturas de personaje de esa unidad tienen la habilidad No sentir dolor 4+.
        </Text>
        ...
        <> 
          ...
          <Text style={styles.descrip}>■ 1 Vargard Obyron – Heroe Epico
            {'\n'}Cada modelo está equipado con: : warscythe.
            {'\n'}1 model ..............................................................85 pts
            </Text>
        </>
      </> 
