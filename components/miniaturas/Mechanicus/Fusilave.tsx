...
export default function Fusilave() {
    return (
        <View>
            <>
                <Image resizeMode="stretch" style={styles.image} source={require('../Mechanicus/images/Fusilave.png')} />
                ...
                <Text style={styles.descrip}>
                    ...
                    {'\n'}<Text style={styles.wapo}>Estante de Bombas:</Text> Cada vez que este modelo termine un movimiento Normal, puedes seleccionar una unidad enemiga sobre la que se haya movido y tirar seis D6: por cada 3+, esa unidad sufre 1 herida mortal.
                </Text>
                <Text style={styles.border}>
        ...
        <>
          ...
          <Text style={styles.descrip}>■ 1 Archaeopter Fusilave
