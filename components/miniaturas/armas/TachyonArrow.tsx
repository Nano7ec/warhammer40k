...
export default function TachyonArrow(){
    return(  
        <View>
          ...
          <>
            <View style={styles.tableCell}>
              ...
              <Text style={styles.cellText}><Text style={styles.wapo}>Tachyon arrow [ONE SHOT]</Text></Text>
            </View>
            <View style={styles.tableCell}>
              <Text style={styles.cellText}>72"</Text>
            </View>
            <View style={styles.tableCell}>
          ...
          One Shot: El portador sólo puede disparar con esta arma una vez por batalla.
          </Text>
        </View>
        </View>
    );
