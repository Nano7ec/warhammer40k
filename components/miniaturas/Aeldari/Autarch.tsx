...
export default function Autarch(){
    return(
        <View>
           <>
        <Image resizeMode="stretch" style={styles.image} source={require('../Aeldari/images/Autarch.png')} />
        ...
        <Text style={styles.descrip}>
          ...
          {'\n'}<Text style={styles.wapo}>Estratega Superlativo:</Text> Una vez por turno, puedes seleccionar esta unidad o una unidad de Estratagema amiga a 6" de esta unidad. Esa unidad puede usar esa Estratagema sin gastar puntos de mando.
        ...
        <>
          ...
          <Text style={styles.descrip}>■ 1 Autarch
