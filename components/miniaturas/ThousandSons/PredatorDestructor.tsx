...
export default function PredatorDestructor() {
    return (
        <View>
            <>
                <Image resizeMode="stretch" style={styles.image} source={require('../ThousandSons/images/PredatorDestructor.png')} />
                ...
                <Text style={styles.descrip}>
                    ...
                    {'\n'}<Text style={styles.wapo}>Destructor:</Text> Cada vez que este modelo realice un ataque a distancia que tenga como objetivo una unidad de Infantería, mejora la característica de Penetración de Armadura de ese ataque en 1.
                </Text>
                <Text style={styles.border}>
                ...
                <View style={styles.tableRow}>
                    <>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}><Text style={styles.wapo}>Bólter pesado de inferno [IMPACTOS SOSTENIDOS 1]</Text></Text>
                        </View>
                        <View style={styles.tableCell}>
                ...
                <View style={styles.tableRow}>
                    <>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}><Text style={styles.wapo}>Cañón láser:</Text></Text>
                        </View>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}>48"</Text>
                        </View>
                ...
                <View style={styles.tableRow}>
                    <>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}><Text style={styles.wapo}>Autocañón de depredador [FUEGO RÁPIDO 2]:</Text></Text>
                        </View>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}>48"</Text>
                        </View>
          ...
          <Text style={styles.descrip}>Este modelo puede estar equipado con una de las siguientes:
            {'\n'}■ 2 cañones láser
            {'\n'}■ 2 bólteres pesados de inferno
            {'\n'}Este modelo puede estar equipado con una de las siguientes:
        ...
        <>
          ...
          <Text style={styles.descrip}>■ 1 Depredador Destructor de los Mil Hijos
          {'\n'}Este modelo está equipado con: autocañón de depredador; orugas blindadas.
           </Text>
        </>
        </View>
    );
