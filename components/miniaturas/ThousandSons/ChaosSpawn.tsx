...
export default function ChaosSpawn() {
    return (
        <View>
            <>
                <Image resizeMode="stretch" style={styles.image} source={require('../ThousandSons/images/ChaosSpawn.png')} />
                ...
                <Text style={styles.descrip}>
                    ...
                    {'\n'}<Text style={styles.wapo}>Monstruosidades Regeneradoras:</Text> Al comienzo de la fase de Mando de cada jugador, un modelo en esta unidad recupera hasta D3 heridas perdidas.
                </Text>
                ...
                <View style={styles.tableRow}>
                    <>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}><Text style={styles.wapo}>Mutaciones horribles:</Text></Text>
                        </View>
                        <View style={styles.tableCell}>
        ...
        <>
          ...
          <Text style={styles.descrip}>■ 2 Engendros del Caos
          {'\n'}Cada modelo está equipado con: mutaciones horribles.
           </Text>
        </>
        </View>
    );
