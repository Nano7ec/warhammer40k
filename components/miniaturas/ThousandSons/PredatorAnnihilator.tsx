...
export default function PredatorAnnihilator() {
    return (
        <View>
            <>
                <Image resizeMode="stretch" style={styles.image} source={require('../ThousandSons/images/PredatorAnnihilator.png')} />
                ...
                <Text style={styles.descrip}>
                    ...
                    {'\n'}<Text style={styles.wapo}>Aniquilador:</Text> Cada vez que este modelo realice un ataque a distancia que tenga como objetivo una unidad de Monstruo o Vehículo, repite una tirada de Daño de 1.
                </Text>
                <Text style={styles.border}>
                ...
                <View style={styles.tableRow}>
                    <>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}><Text style={styles.wapo}>Cañón láser de depredador gemelo [GEMELO]:</Text></Text>
                        </View>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}>48"</Text>
                        </View>
        ...
        <>
          ...
          <Text style={styles.descrip}>■ 1 Depredador Aniquilador de los Mil Hijos
          {'\n'}Este modelo está equipado con: cañón láser de depredador gemelo; orugas blindadas.
           </Text>
        </>
        </View>
    );
