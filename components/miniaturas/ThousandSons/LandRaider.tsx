...
export default function LandRaider() {
    return (
        <View>
            <>
                <Image resizeMode="stretch" style={styles.image} source={require('../ThousandSons/images/LandRaider.png')} />
                ...
                <Text style={styles.descrip}>
                    ...
                    {'\n'}<Text style={styles.wapo}>Rampa de Asalto:</Text> Cada vez que una unidad desembarque de este Transporte después de haber realizado un movimiento Normal, esa unidad aún puede declarar una carga este turno.
                </Text>
                <Text style={styles.border}>
                DAÑADO: 1-5 HERIDAS RESTANTES
                </Text>
                <Text style={styles.descrip}>
                    Mientras este modelo tenga 1-5 heridas restantes, cada vez que realice un ataque, resta 1 de la tirada para impactar.
                </Text>
                ...
                <View style={styles.tableRow}>
                    <>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}><Text style={styles.wapo}>Cañón láser de desgarrador de almas:</Text></Text>
                        </View>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}>48"</Text>
                        </View>
                ...
                <View style={styles.tableRow}>
                    <>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}><Text style={styles.wapo}>Bólter pesado de inferno gemelo [IMPACTOS SOSTENIDOS 1, GEMELO]:</Text></Text>
                        </View>
                        <View style={styles.tableCell}>
                            <Text style={styles.cellText}>24"</Text>
                        </View>
        ...
        <>
          ...
          <Text style={styles.descrip}>■ 1 Land Raider de los Mil Hijos
          {'\n'}Este modelo está equipado con: 2 cañones láser de desgarrador de almas; bólter pesado de inferno gemelo; orugas blindadas.
           </Text>
        </>
        <>
          <Text style={styles.border}>
          ...
          <Text style={styles.descrip}>Este modelo tiene una capacidad de transporte de 12 modelos de Infantería de los Mil Hijos (excluyendo modelos de Cultista y Tzaangor).
           </Text>
        </>
        </View>
    );
