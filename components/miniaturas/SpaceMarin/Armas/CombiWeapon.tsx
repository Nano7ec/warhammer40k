...
export default function CombiWeapon(){
    return(  
        <View>
          ...
          <>
            <View style={styles.tableCell}>
              ...
              <Text style={styles.cellText}><Text style={styles.wapo}>Combi-weapon
              {'\n'}[ANTI-INFANTRY 4+, DEVASTATING WOUNDS, RAPID FIRE 1] </Text></Text>
            </View>
            <View style={styles.tableCell}>
